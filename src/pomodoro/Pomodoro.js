...
function Pomodoro() {
  ...
  // useInterval(callback, interval) runs callback at that interval
  useInterval(
    () => {
    ...
    // don't forget to change this back to 1000 - this is only for debugging to have it at 100
